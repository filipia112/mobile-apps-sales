...
class StockOutList extends StatelessWidget {
  final List<Map<String, String>> StockOuts = [
    {
      'batchNomer': 'B1820021',
      'nmPabrik': 'PIM',
  ...
  Widget build(BuildContext context) {
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        return StockOutCard(
          batchNomer: StockOuts[index]['batchNomer']!,
          namePabrik: StockOuts[index]['nmPabrik']!,
          nameSupplier: StockOuts[index]['nmSupplier']!,
          totalStock: StockOuts[index]['jumlahStok']!,
          nameProduct: StockOuts[index]['nmProduk']!,
        );
      },
    );
  }
